...
class generateHandUCTPlayer extends Player {
    ...
    generateHandUCTPlayer(String name) { 
		super(name); 
		System.out.println("generateHandUCTPlayer AI ("+name+") initialized."); 
    ...
    @Override
    Player resetPlayer() { return new generateHandUCTPlayer(name); }
    ...
    private void addNewChild(Node parentNode, int childIndex) {
        ...
        if (playerIndex == myPNumber) {
            ...
            // usual case - there are children to add / cards in the child's hand
                ...
                childHand = generateHand(childState, parentNode);
